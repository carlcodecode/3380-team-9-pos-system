...
export const StaffManagement = ({ onBack }) => {
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-black">
              {viewMode === 'add' ? 'Add Staff Account' : 'Edit Staff Account'}
            </h2>
          </div>
          <div className="flex gap-2">
            <Button
  ...
  return (
    <>
      ...
      {(viewMode === 'add' || viewMode === 'edit') && renderStaffForm()}
      {viewMode === 'view' && renderStaffView()}
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
                    <li>5 Meals created by this staff will be reassigned to 'System'.</li>
